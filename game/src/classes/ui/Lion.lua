...
function Lion:createFromIndexes(indexes)
  ...
  self.crownTwoIndex = indexes.crown_2 or 1
  self.eyesIndex = indexes.eyes or 1
  self.headIndex = indexes.head or 1
  self.mouthIndex = indexes.mouth or 1
  self.noseIndex = indexes.nose or 1
  self.shouldersIndex = indexes.shoulders or 1
