...
function Animator:isAnimating(property)
  -- Vérifie les animations actives
  for _, a in ipairs(self.active) do
    if a.property == property then
      return true
    end
  end

  -- Vérifie les animations en queue
  for _, group in ipairs(self.queue) do
    for _, a in ipairs(group) do
      if a.property == property then
        return true
