...
function GameOverScreen:draw()
    ...
    local text = love.graphics.newText(Fonts.soraBig, "Game Over")
    local summarytext = love.graphics.newText(Fonts.soraSmall, "Round : "..tostring(self.run.roundNumber).. ' - Score : '.. tostring(self.run.currentRound.roundScore) .. ' - Target : ' ..tostring(self.run.currentRound.targetScore))
